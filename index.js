...
F.require = function(path) {
	return modules[path] ? require(path) : CONF.node_modules && CONF.node_modules[0] === '~' ? Path.join(CONF.node_modules.substring(1), path) : require(Path.join(F.directory, CONF.node_modules, path));
};
